    ...
    (c.prototype = {
        ...
        growDown: function (a, b) {
            ...
            return (
                ...
                (c = this.findNode(this.root, a, b))
                    ? this.splitNode(c, a, b)
                    : null
            );
        },
    }),
        (b.fn.filterizr = function () {
            ...
            if (
                ...
                if (c[0].lastIndexOf('_') > -1)
                    throw new Error(
                        'Filterizr error: You cannot call private methods',
                    );
                if ('function' != typeof a._fltr[c[0]])
                    throw new Error(
                        'Filterizr error: There is no such function',
                    );
                a._fltr[c[0]](c[1], c[2]);
            }
            return a;
        ...
        (b.fn.filterizr.prototype = {
            init: function (a, c) {
                ...
                return (
                    ...
                    (d._activeArray = d._getCollectionByFilter(
                        d.options.filter,
                    )),
            ...
            search: function (a) {
                ...
                if (b._isSearchActivated())
                    for (e = 0; e < c.length; e++) {
                        var f =
                            c[e].text().toLowerCase().indexOf(a.toLowerCase()) >
                            -1;
                        f && d.push(c[e]);
                    }
            ...
            sort: function (a, b) {
                ...
                c._isSearchActivated()
                    ? c.search(c._typedText)
                    : c._placeItems(f);
            },
            ...
            _makeSubarrays: function () {
                ...
                for (c = 0; c < a._mainArray.length; c++)
                    if ('object' == typeof a._mainArray[c]._category)
                        for (
                            var d = a._mainArray[c]._category.length, e = 0;
                            e < d;
                            e++
                        )
                            b[a._mainArray[c]._category[e] - 1].push(
                                a._mainArray[c],
                            );
            ...
            _calcItemPositions: function () {
                var a = this,
                    ...
                    e = 0,
                    f = Math.round(
                        a.width() / a.find('.filtr-item').outerWidth(),
                    ),
                    g = 0,
                    h = d[0].outerWidth(),
                    i = 0,
                ...
                if ('horizontal' === a.options.layout)
                    ...
                    for (l = 1; l <= d.length; l++) {
                        if (
                            ...
                            for (m = g; m > 0; )
                                (k += d[l - f * m].outerHeight()), m--;
                        l % f == 0 && (j = 0);
                    }
                    for (l = 0; l < f; l++) {
                        for (var s = 0, t = l; d[t]; )
                            (s += d[t].outerHeight()), (t += f);
                        s > e ? ((e = s), (s = 0)) : (s = 0);
                    }
            ...
            _handleFiltering: function (a) {
                for (
                    var b = this,
                        c = b._getArrayOfUniqueItems(b._activeArray, a),
                        d = 0;
                    d < c.length;
                    d++
                )
    ...
    var d = {
        ...
        _onTransitionEnd: function () {
            ...
            a._filteringOut
                ? (b(a).addClass('filteredOut'),
                  ...
                  (a._filteringOut = !1))
                : a._filteringIn &&
                  ((a._isFilteredOut = !1), (a._filteringIn = !1)),
        ...
        _filterIn: function (a) {
            ...
            b(c).removeClass('filteredOut'),
                ...
                (d.transform +=
                    ' translate3d(' + a.left + 'px,' + a.top + 'px, 0)'),
                c.css(d);
        },
    };
})(this, jQuery);
